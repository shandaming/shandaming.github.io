...
<!--more-->
In the document today, I didn't notice Pan Long when I read it, it was careless. For domestic financial investment. I found that it takes several days for subscription and redemption, which is inefficient. For reading, I find that many books are not effective, and I should only specialize in a few interesting directions, while others can only be understood.
* Don't be careless, check carefully.

今天在文档中，我看的时候没有注意到蟠龙，真是粗心。对于国内理财投资，我发现申购和赎回都需要几天的时间，这效率很低。对于看书，我发现看很多书效果不明显，应该只专精几个感兴趣的方向，其他的只要了解下就可以了。
* 做事不能粗心，要仔细的检查。

感恩练习：
* Thanks to Peng Huiquan for debugging the project with me.
* 感谢彭灰泉与我一起调试项目。
* 感谢心理学书籍，让我知道上面的方法有效
