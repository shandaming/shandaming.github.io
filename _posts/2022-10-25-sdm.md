...
<!--more-->
Today, I tested the alarms of the project and found that I had filled in some parameters and URLs incorrectly, causing many problems. It was modified before and not tested. I'm really too irresponsible. It is really garbage.
* The code that has modified the project must be tested.

今天测试项目的告警，发现我有些参数和URL填写的不对，导致问题很多。之前修改过后，没有测试。我真实太不负责了。真是垃圾。
* 修改过项目的代码，一定要测试。

感恩练习：
* Thanks to Pang Long and Peng Huiquan for cooperating with me to check the project problems.
* 感谢蟠龙和彭灰泉配合我查看项目问题。
* 感谢心理学书籍，让我知道上面的方法有效
