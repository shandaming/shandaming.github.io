---
layout: post
title: “Careless, Not responsible for work"
author: "shandaming"
tags: 生活
...
<!--more-->
Today, Mr Luo pointed out the porblem of the code I wrote when dealing with SMC3.0 split screen. The split screen is either an automatic split screen or a designated supplementary screen. There can only be one, and I deal with these two at the same time in the same logic. I’m Really careless and don't think about logic carefully.
* Do things carefully, write code, draw pictures, and sort sout the process.
今天,罗总指出了我写的代码在处理SMC3.0分屏时的问题，分屏那要么是自动分屏，要么是指定补充屏幕，只能有一个，而我在同一个逻辑里同时处理这2个. 我真是粗心，不仔细考虑逻辑
* 做事要仔细，写代码要画图，梳理好流程

感恩练习：
* Thank you Mr Luo for pointing out my carelssness.
* 感谢罗总指出我的粗心
* 感谢心理学书籍，让我知道上面的方法有效
