...
<!--more-->
Today found before the Zhang Hao said jiangsu weather split screen when there is a lack of resources, and I did not propose to check the log to confirm, directly believe what he said, which is very irresponsible, the future of things must be carefully checked , not missed, careless.

今天发现之前张号说江苏气象分屏时出现资源不足的问题，而我也没有提出查看日志来确认，直接相信他说的，这很不负责，以后做事必须要仔细的检查，不能遗漏，粗心。
