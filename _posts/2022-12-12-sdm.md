...
<!--more-->
This evening after work, Peng Huiquan still looking for me to see the problem, I was very impatient, want to leave early, and he spoke in a rushed tone, and his feedback is indeed the problem, I did not do the test when I modified before, directly to their version, which is not the right way to modify the code must be tested, in the release version.

今天晚上下班后，彭灰泉还找我看问题，我当时很急躁，想早点走，和他说话语气冲人，而且他反馈的确实是问题，我之前修改的时候没有做测试，直接给他们版本了，这方式是不对，以后修改代码必须要做测试，在发布版本。

感恩练习：
* Thanks to Peng Huiquan for giving me feedback on the problem
* 感谢彭灰泉向我反馈问题。
* 感谢心理学书籍，让我知道上面的方法有效
