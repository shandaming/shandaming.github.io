...
<!--more-->
Today Yang Qinglong encountered a small fish cascade problem, let me go over to see, I think it is their configuration error, or the wrong way to operate, I let them he try, but they repeatedly let me go over to see. I just stubbornly do not want to go over.
* I made the mistake of "thinking" agin, and stubbornly, I have to verify the problems I encountered, I must correct this problem.

今天杨青龙遇到小鱼级联的问题，让我过去看看，我认为这是他们配置的错误，或者操作方式不对，我让他们他尝试下，但是他们多次的让我过去看看，我就是固执的不想过去。
* 我又犯了“自己认为”的错误，并且固执，遇到的问题必须要验证才行，必须改正这毛病。

感恩练习：
* Thanks to Yang Qinglong for cooperating with me to debug the project cascade problem.
* 感谢杨清龙配合我调试项目级联问题
* 感谢心理学书籍，让我知道上面的方法有效
